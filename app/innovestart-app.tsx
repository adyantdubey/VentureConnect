    ...
    <Dialog.Root open onOpenChange={(open) => { if (!open) onClose(); }}>
      <Dialog.Portal>
        ...
        <Dialog.Content className={`modal-panel ${wide ? "modal-wide" : ""}`}>
          <Dialog.Title className="sr-only">Innovestart dialog</Dialog.Title>
          <Dialog.Description className="sr-only">Focused Innovestart workspace dialog</Dialog.Description>
